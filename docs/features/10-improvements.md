...
### Wave 47 — Phase 2 capstone audit 2 of 5: Images chapters 06 + 07 (in progress 2026-05-06)
...
| # | Tag | SHA | What landed | Tests |
|---|---|---|---|---:|
| 1 | (doc)         | this    | Wave 47 mid-wave (start) — register Wave 47 in §10.5 + §10.6 with the Images chapters 06 + 07 design + Phase 2 capstone audit 2 of 5 framing per §10.5.2 closure plan + audit findings of 2 distinct chapter drift narratives. Updates §10.1 wave-status + §10.4 reservation rows for IMPROVE-187 + IMPROVE-188. | 0 |
| 2 | [IMPROVE-187] | TBD     | MODIFIED `docs/features/06-image-generation.md` — line count + ~14 line refs + 4 api_server.py route refs + OOM ladder narrative + accelerate probe context + §6.22 closure markers. §10.4 IMPROVE-44 row gains ✓. Pure doc commit; no code changes. | 0 |
| 3 | [IMPROVE-188] | TBD     | MODIFIED `docs/features/07-image-editor.md` — 3 line-count corrections + ~10 line refs + §7.10 api_server.py ref redirect + §7.13 5 IMPROVE-N closure markers + NEW §7.14 metrics pipeline subsection. §10.4 IMPROVE-49/53/54/55/56 rows gain ✓. Pure doc commit; no code changes. | 0 |
| 4 | (doc)         | TBD     | Wave 47 end-wave retrospective + Phase 2 audit 2 of 5 close summary. Flips Wave 47 status (in progress → ✓ shipped). Adds ✓ prefix on §10.4 IMPROVE-187/188 rows. Fills in mid-wave + numbered SHA placeholders. NEW Wave 47 architectural impact subsection. NEW post-Wave-47 backlog. | 0 |
...
### Wave 47 (in progress) — Phase 2 audit 2 of 5: Images chapters 06 + 07
