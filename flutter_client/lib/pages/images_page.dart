...
class _ImagesPageState extends State<ImagesPage> {
  ...
  Future<void> _load() async {
    ...
    final models = await widget.api.get('/images/models') as Map<String, dynamic>;
    setState(() {
          ...
          child: Card(
            child: Column(children: [
              ListTile(
                ...
                trailing: IconButton(onPressed: _createSession, icon: const Icon(Icons.add)),
              ),
              Expanded(
                child: ListView(
                  children: _sessions
                ...
                Expanded(
                  child: selectedUrl == null
                      ...
                      : InteractiveViewer(
                          minScale: 0.5,
                          maxScale: 4,
                          child: Center(child: Image.network(selectedUrl)),
                        ),
                ),
